...
2. If your Little Esty Shop project is not complete, fork [this repo](https://github.com/turingschool-examples/little_esty_shop_bulk_discounts) as a starting point for this project.
3. Scaffolding is not permitted for this project.
4. Additional gems for this project needs to be approved by instructors.
...
- [ ]  Merchants can have multiple bulk discounts
    - [ ]  If an item meets the quantity threshold for multiple bulk discounts,
    - [ ]  **only the one with the greatest percentage discount should be applied**
- [ ]  Bulk discounts should apply on a per-item basis
    - [ ]  If the quantity of an item ordered meets or exceeds the quantity threshold, then
    - [ ]  the percentage discount should apply to that item only.
