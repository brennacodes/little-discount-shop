...
ActiveRecord::Schema[7.0].define(version: 2022_08_06_205708) do
  ...
  create_table "discount_invoice_items", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["discount_id"], name: "index_discount_invoice_items_on_discount_id"
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.datetime "credit_card_expiration_date", precision: nil
    t.integer "result"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  ...
  add_foreign_key "discount_invoice_items", "discounts"
